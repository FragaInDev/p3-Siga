...
@Controller
public class SoNoiteNotasController {
	
	@Autowired
	private NotasDAO nDao;
	
	@RequestMapping(name = "soNN", value = "/soNN", method = RequestMethod.GET)
	public ModelAndView init(ModelMap model) {
		return new ModelAndView("soNN");
	}
	
	@RequestMapping(name = "soNN", value = "/soNN", method = RequestMethod.POST)
