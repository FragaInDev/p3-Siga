...
@Controller
public class LabhNotasController {
	
	@Autowired
	private NotasDAO nDao;
	
	@RequestMapping(name = "labhN", value = "/labhN", method = RequestMethod.GET)
	public ModelAndView init(ModelMap model) {
		return new ModelAndView("labhN");
	}
	
	@RequestMapping(name = "labhN", value = "/labhN", method = RequestMethod.POST)
