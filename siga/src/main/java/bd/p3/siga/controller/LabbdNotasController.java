...
@Controller
public class LabbdNotasController {
	
	@Autowired
	private NotasDAO nDao;
	
	@RequestMapping(name = "labbdN", value = "/labbdN", method = RequestMethod.GET)
	public ModelAndView init(ModelMap model) {
		return new ModelAndView("labbdN");
	}
	
	@RequestMapping(name = "labbdN", value = "/labbdN", method = RequestMethod.POST)
