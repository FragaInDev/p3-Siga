...
@Controller
public class SoTardeNotasController {
	
	@Autowired
	private NotasDAO nDao;
	
	@RequestMapping(name = "soTN", value = "/soTN", method = RequestMethod.GET)
	public ModelAndView init(ModelMap model) {
		return new ModelAndView("soTN");
	}
	
	@RequestMapping(name = "soTN", value = "/soTN", method = RequestMethod.POST)
