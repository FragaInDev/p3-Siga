...
@Controller
public class BdNotasController {
	
	@Autowired
	private NotasDAO nDao;
	
	@RequestMapping(name = "bdN", value = "/bdN", method = RequestMethod.GET)
	public ModelAndView init(ModelMap model) {
		return new ModelAndView("bdN");
	}
	
	@RequestMapping(name = "bdN", value = "/bdN", method = RequestMethod.POST)
