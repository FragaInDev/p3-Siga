...
<title>Lab Hardware | Notas</title>
</head>
<body>
	<div>
    ...
    <br/>
	<div align="center">
		<h1>Notas Laboratório de Hardware</h1>
		<br/>
		<form action="labhN" method="post">
			<table>
				<tr>
					<td>
					...
					<td>
						<input class="input" id="disciplina" name="disciplina" value="4208010">
					</td>
					<td>
