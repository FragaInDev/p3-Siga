...
<body>
    ...
    <br/>
	<div align="center">
		<h1>Notas Sistemas Operacionais I - Tarde</h1>
		<br/>
		<form action="soTN" method="post">
			<table>
				<tr>
					<td>
					...
					<td>
						<input class="input" id="disciplina" name="disciplina" value="4213003">
					</td>
					<td>
