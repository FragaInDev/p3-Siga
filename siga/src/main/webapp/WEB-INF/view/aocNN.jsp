...
<body>
    ...
    <br/>
	<div align="center">
		<h1>Notas Arquitetura e Organização de Computadores - Noite</h1>
		<br/>
		<form action="aocNN" method="post">
			<table>
				<tr>
					<td>
					...
					<td>
						<input class="input" id="disciplina" name="disciplina" value="4203020">
					</td>
					<td>
						<input class="input" id="av" name="av" placeholder="Avaliação">
					</td>
					<td>
