...
<body>
    ...
    <br/>
	<div align="center">
		<h1>Notas Métodos Para a Produção do Conhecimento</h1>
		<br/>
		<form action="mppcN" method="post">
			<table>
				<tr>
					<td>
					...
					<td>
						<input class="input" id="disciplina" name="disciplina" value="5005220">
					</td>
					<td>
						<select id="av" name="av">
							<option value= "0">Escolha o tipo de avaliação</option>
							<option value= "10">Monografia Completa</option>
							<option value= "11">Monografia Resumida</option>
						</select>
					</td>
					<td>
